...
public class OverlayWindow : MonoBehaviour {
	...
	public static bool formShow = false;
	...
	public static void ShowLMedia(string mediaName) {
		instance.visible_ = true;
		formShow = true;
		// [iPhone]
#if UNITY_IPHONE
		if (Application.platform == RuntimePlatform.IPhonePlayer) {
			_OverlayWindowShowForm(mediaName);
		}
#endif
	}
	...
	[DllImport ("__Internal")]
	private static extern void _OverlayWindowShowForm(string mediaName);
	[DllImport ("__Internal")]
